...
Q: Describe in your own words what the HashMap does.
A: 
HashMap is a data structure that allows you to store and retrieve values using keys. It provides a way to map a unique key to a specific value, and then later retrieve that value using the same key.
