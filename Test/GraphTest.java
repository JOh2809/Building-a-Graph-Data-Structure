...
class GraphTest {
    ...
    void outDegree() {
        ...
        g.addEdge(v0, v1);
        g.addEdge(v0, v2);
        assertEquals(2, g.outDegree(v0), "Incorrect out-degree");
        assertEquals(0, g.outDegree(v1), "Incorrect out-degree");
        assertEquals(0, g.outDegree(v2), "Incorrect out-degree");
    }
